...
```
Kết quả:
![ketqua1](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/mwvxkbfo5z_image.png)
...
```
Cây thư mục như sau:
![alt text](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/ad3s36a9p7_image.png)
...
![alt text](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/d8hzqa1v5f_image.png)
...
![alt text](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/orroyc7h1p_image.png)
...
## Lỗi opencv với libgstreamer
```
...
//usr/lib/x86_64-linux-gnu/libgstreamer-0.10.so.0: undefined reference to `xmlOutputBufferCreateFile@LIBXML2_2.4.30'
...
```
Lỗi này do thư viện gstreamer

Khắc phục:
```
sudo apt-get install gstreamer1.0*
```
trong qúa trình cài gstreamer1.0* có thể có lỗi do thiếu thư viện, lỗi báo thiếu thư viện nào thì cài thư viện đó

```
sudo apt-get install libandroid-properties1:i386 libmedia1:i386
```

--> Vẫn chưa fix được lỗi đó 

**Nguyên nhân chính:** Do không link được tới thư viện LibXml2

Khắc phục: Thêm vào CMakeLists.txt hai dòng:
```
...
